...
class Spider(BaseSpider):
    ...
    def _load_categories(self, text):
        ...
        # ---------- 要移除的分类（视频一区、视频五区、热搜视频） ----------
        remove_list = ['视频一区', '视频五区', '热搜视频']
        # -----------------------------------------------------------------
